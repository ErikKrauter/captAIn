...
class PandaDefaultConfig:
    ...
    def controllers(self):
        ...
        arm_pd_base_pose = deepcopy(arm_pd_ee_delta_pose)
        arm_pd_base_pose.frame = "base"
        arm_pd_base_pose.use_delta = False
        arm_pd_base_pose.normalize_action = False
        ...
        controller_configs = dict(
            ...
            pd_base_pose=dict(arm=arm_pd_base_pose, gripper=gripper_pd_joint_pos)
        )
