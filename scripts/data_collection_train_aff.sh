...
WORK_DIR="DatasetsAndModels/DatasetTrainAff"
...
python ManiSkill2-Learn/maniskill2_learn/apis/run_rl.py \
  ...
  --cfg-options "env_cfg.control_mode=pd_ee_target_delta_pose" "eval_cfg.affordance_predictor_data_set=True" \
  "eval_cfg.augment_dataset=True" "eval_cfg.only_save_success_traj=False" "eval_cfg.num=5000"
