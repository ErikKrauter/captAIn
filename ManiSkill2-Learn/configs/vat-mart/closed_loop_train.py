...
train_cfg = dict(
    ...
    n_steps=20,  # collect N transitions in environment. MUST BE DEVISIBLE BY num_procs, because n_steps is spread over vectorized environment
    ...
    print_steps=10,  # in episodes: break out of interaction/training loop every N episodes for printing to the terminal
    ep_stats_cfg=dict(
        info_keys_mode=dict(
