agent_cfg = dict(
    ...
    feat_dim=128,
    mode='inference',
    trajectory_scorer_checkpoint_path="DatasetsAndModels/VAT-Mart_Models/TrajectoryScorer_Model/model_7168.ckpt",
    trajectory_generator_checkpoint_path="DatasetsAndModels/VAT-Mart_Models/TrajectoryGenerator_Model/model_35840.ckpt",
    affordance_predictor_checkpoint_path="DatasetsAndModels/VAT-Mart_Models/AffordancePredictor_Model/model_29696.ckpt",
...
eval_cfg = dict(
    type="Evaluation",
    num_procs=1,   # uploading videos to wandb only works when using one process.
    num=100,
