agent_cfg = dict(
    ...
    feat_dim=128,
    mode='inference',
    trajectory_scorer_checkpoint_path="Experiments/trajScorer_6dim_4wp/models/model_final.ckpt",  #'DatasetsAndModels/TrainedModels/VAT_modules/Scor_UseNoReverseContactsImproved/models/model_17500.ckpt', #'DatasetsAndModels/TrainedModels/VAT_modules/Scor_NonContact/models/model_18000.ckpt',  # 'DatasetsAndModels/TrainedModels/VAT_modules/Scor_FinalAugmentation/models/model_25000.ckpt',  # 'DatasetsAndModels/TrainedModels/VAT_modules/ScorNoDuplicatesDataAugmentation/models/model_50000.ckpt',
    trajectory_generator_checkpoint_path="Experiments/trajGen_6dim_4wp/models/model_final.ckpt", #'DatasetsAndModels/TrainedModels/VAT_modules/Gen_HigherKLWeight_LowerDirLoss/models/model_55500.ckpt',  #'DatasetsAndModels/TrainedModels/VAT_modules/Gen_UseNoReverseContactsImproved/models/model_21500.ckpt' ,#'DatasetsAndModels/TrainedModels/VAT_modules/Gen_NonContact/models/model_72000.ckpt',  # 'DatasetsAndModels/TrainedModels/VAT_modules/Gen_FinalAugmentation/models/model_30000.ckpt',  # 'DatasetsAndModels/TrainedModels/VAT_modules/GenNoDuplicatesDataAugmentation/models/model_70000.ckpt',
    affordance_predictor_checkpoint_path="Experiments/affPred_6dim_4wp/models/model_final.ckpt", #'DatasetsAndModels/TrainedModels/VAT_modules/Aff_UseNoReverseContactsImproved/models/model_9500.ckpt', #'DatasetsAndModels/TrainedModels/VAT_modules/Aff_NonContact2/models/model_15000.ckpt',  # 'DatasetsAndModels/TrainedModels/VAT_modules/Aff_NonContact/models/model_11000.ckpt',  # 'DatasetsAndModels/TrainedModels/VAT_modules/Aff_UseFinalAugmentation2/models/model_2500.ckpt', #'DatasetsAndModels/TrainedModels/VAT_modules/AffUseNoDuplicatesDataAugmentation/models/model_10000.ckpt',
    ...
    trajectory_generator_cfg=dict(
        ...
        vae_cfg=dict(
            ...
            decoder_cfg=dict(  # three layer MLP, Called ActorDecoder in Baseline
                ...
                mlp_spec=[128 + 32 + 128 + 32, 512, 256, 'trajectory_dim'],
                # feat_dim + task_feat_dim + traj_feat_dim + cp_feat_dim, 512, 256, num waypoints  * waypoint
                inactivated_output=True,
                linear_init_cfg=dict(
                    type="xavier_init",
                    gain=1,
...
env_cfg = dict(
        ...
        obs_mode='VAT-inference',  # adds camera segmentation to segment out the robot arm so we can visualize its motion without occluding the pointcloud
        obs_frame='base',
        n_points=650,
        # render_mode='human',
        ignore_dones=False,
        ...
        faucets='faucetTrainingDataSet.txt',  # "faucetTrainingDataSet.txt", 'faucetID_HoldOutDataSet.txt' 'faucetOOD_HoldOutDataSet.txt'
        # friction=0.1 * 5.0,
        # damping=2.0 * 5.0,
)
...
'''eval_cfg = dict(
    ...
    save_video=False,
    log_every_step=False,
    id_faucets='faucetTrainingDataSet_Debug.txt', #'faucetID_HoldOutDataSet.txt',
    ood_faucets='faucetTrainingDataSet_Debug.txt', #'faucetOOD_HoldOutDataSet.txt'
    augment_dataset=False,
    only_save_success_traj=False
)'''
