...
class SAC(BaseAgent):
    def __init__(
        ...
        **kwargs
        ...
        # I believe this is incorrect, as this results in sharing the visual backbone between critic, actor, and target
        # critic. Instead, a deepcopy of the critic_cfg must be passed to the function here
