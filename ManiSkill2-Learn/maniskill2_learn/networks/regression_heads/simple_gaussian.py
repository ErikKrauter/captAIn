...
class SimpleGaussianHeadBase(ExtendedModule):
    def __init__(self, scale_prior=1, bias_prior=0, dim_action=None, epsilon=1E-6):
        super(SimpleGaussianHeadBase, self).__init__()
...
class SimpleGaussianHead(SimpleGaussianHeadBase):
    def __init__(self, scale_prior=1, bias_prior=0, dim_action=None, log_sig_min=-20, log_sig_max=2, epsilon=1e-6):
        super(SimpleGaussianHead, self).__init__(scale_prior, bias_prior, dim_action, epsilon)
...
@REGHEADS.register_module()
class SharedGaussianHead(SimpleGaussianHeadBase):
    def __init__(self, scale_prior=1, bias_prior=0, dim_action=None, epsilon=1e-6):
