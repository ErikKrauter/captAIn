...
class Visuomotor(ExtendedModule):
    def __init__(
        ...
        # the feature extractor is the backbone NN, i.e. PointNet or PointNet2 for point cloud inputs
        ...
        **kwargs,
        ...
        for key in ["state", "agent"]:
            if key in obs:
                ...
                robot_state = obs.pop(key)  # robot_state contains the actor's action in the case that the critic called backbone
        ...
        if feature is None:
            ...
            if robot_state is not None and with_robot_state:  # robot_state is B, 31 --> ndim==2
                assert (
            ...
            feat = feature
        #  after concatenation feat as dim B, 159 (128+31)
