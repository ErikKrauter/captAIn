...
def get_kwargs_from_shape(obs_shape, action_shape, trajectory_dim=None, n_points=None):
    ...
    if trajectory_dim is not None:
        replaceable_kwargs["trajectory_dim"] = deepcopy(trajectory_dim)
    if n_points is not None:
        replaceable_kwargs["n_points"] = deepcopy(n_points)
